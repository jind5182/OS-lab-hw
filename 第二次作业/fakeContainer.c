...
const char* rootfs = "/var/lib/lxc/myubuntu/rootfs";
...
struct cgroup*  cgroup_control(pid_t pid){
    ...
    if ( cgroup_set_value_uint64(cgc_memory, "memory.limit_in_bytes", MEMORY_LIMIT) ){
        printf("Error limit memory limit_in_bytes.\n");
        goto out;   
    } 
